    ...
    implements GraphBuilder
{
        ...
        throws CycleDetectedException, DuplicateProjectException
    {
        ...
        // 第一次进入该方法时 session.getProjectDependencyGraph() == null
        // &&
        ...
        throws ProjectBuildingException
    {
        ...
        // 1. 给ProjectBuilderRequest对象赋值RepositorySystemSession对象
        ...
        // 5. 读取pom文件, 然后创建为Project对象, 放入 { projects } 集合中
    ...
    /**
     *
     * @param projects  传出参数,创建出来的MavenProject对象放入到这个集合中
     * @param files     pom文件集合,其实只有一个
     * @param request
     */
    private void collectProjects( List<MavenProject> projects,
                                  List<File> files,
                                  MavenExecutionRequest request
    )
        throws ProjectBuildingException
    {
        ...
        // 委托给ProjectBuilder去创建MavenProject
